...
#b = Bridge('192.168.1.45')
#b.connect()


#base_url = 'http://192.168.1.65:8080/rest'
#global items
#openhab = openHAB(base_url)
#items = openhab.fetch_all_items()
#global fan_item
#fan_item = openhab.get_item('smart_plug_2') 
#global globe_item
#globe_item = openhab.get_item('fan') 
...
#Buttons
Button1 = Button(root, bg = "black",border = "0", image=playimg,command=play, height = 100, width = 100).grid(row=3, column=2, sticky=W)
